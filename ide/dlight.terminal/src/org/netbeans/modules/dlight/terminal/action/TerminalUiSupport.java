...
public final class TerminalUiSupport {

    private TerminalUiSupport() {
    }
    ...
    public static Component getToolbarPresenter(Action action) {
        ...
        if (icon == null) {
            icon = ImageUtilities.loadImageIcon("org/netbeans/modules/dlight/terminal/action/local_term.svg", false); // NOI18N
        }
